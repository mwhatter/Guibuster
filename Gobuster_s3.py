...
class S3Window:
    def __init__(self, root):
        ...
        self.window.title("Gobuster S3")
        self.window.geometry("800x600")
        self.window.configure(bg=BG_COLOR)

        title_frame = tk.Frame(self.window, bg=BG_COLOR)
        title_frame.pack(pady=10)
        tk.Label(title_frame, text="Gobuster S3", font=("Helvetica", 20, "bold"), fg=FG_COLOR, bg=BG_COLOR).pack()
...
"""
        ScrollableHelpWindow(self.root, "S3 Help", help_text)
